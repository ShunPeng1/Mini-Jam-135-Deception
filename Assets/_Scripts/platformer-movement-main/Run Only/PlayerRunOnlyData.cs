...
[CreateAssetMenu(menuName = "Platformer/Player Run Data")] //Create a new playerData object by right clicking in the Project Menu then Create/Player/Player Data and drag onto the player
public class PlayerRunOnlyData : ScriptableObject
{
	[Header("Run")]
