...
[CreateAssetMenu(menuName = "Platformer/Player Run Jump Data")] //Create a new playerData object by right clicking in the Project Menu then Create/Player/Player Data and drag onto the player
public class PlayerRunJumpData : ScriptableObject
{
	[Header("Gravity")]
